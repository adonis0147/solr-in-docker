...
sudo -u hadoop mv "${hadoop_conf_path}" /data/conf/hadoop-conf

JAVA_HOME='/usr/lib/jvm/java-1.8.0-openjdk-amd64'
HADOOP_LOG_DIR='/home/hadoop/cluster-data/hadoop/logs'
HADOOP_PID_DIR='/home/hadoop/cluster-data/hadoop/pids'
...
'
sudo -u hadoop sed -i "${commands}" /data/conf/hadoop-conf/hadoop-env.sh
sudo -u hadoop ln -snf /data/conf/hadoop-conf "${hadoop_conf_path}"
